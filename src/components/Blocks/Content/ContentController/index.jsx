/*
 * Compnents - Blocks - Content - Controller
 */

import { ContentBlocks } from '@/components/Blocks/Content';
...
const ContentController = ({ blocks = [] }) => {
    const Content = () => {
        return (
            blocks.map((block, i) => {
                const Block = <ContentBlocks key={`content-${i}`} {...block} index={i} />;
                const { props } = Block || {};
